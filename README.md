...
- removed direct dependency to the Stanford Parser → the Stanford Parser is called via reflection now (the direct dependency of [srijiths/jtopia](https://github.com/srijiths/jtopia) technically results in a license-conflict as the Stanford Parser is GPL and therefore would infect jtopia aswell)
